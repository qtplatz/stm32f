...
namespace stm32f103 {
    ...
    uint32_t system_clock::epoch_compensation;
    ...
    {
        return std::chrono::duration_cast< std::chrono::seconds >( t - zero ).count()
            + stm32f103::rtc::__epoch_offset__ // 2018-JAN-01 00:00 UTC
            + system_clock::epoch_compensation;
    }

    void
    system_clock::set_epoch_compensation( uint32_t comp )
    {
        epoch_compensation = comp;
    }
}
